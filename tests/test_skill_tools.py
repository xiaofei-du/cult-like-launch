...
class SkillToolsTests(unittest.TestCase):
    def setUp(self):
        ...
        self.files = {
            ...
            "agents/openai.yaml": (
                ...
                '  default_prompt: "Use $cult-like-launch to draft a playbook."\n'
            ).encode(),
    ...
    def test_metadata_must_invoke_the_declared_skill(self):
        ...
        path.write_text(path.read_text().replace("$cult-like-launch", "$another-skill"))
    ...
    def test_bundle_preserves_bytes_and_excludes_unlisted_material(self):
        ...
        with zipfile.ZipFile(output) as archive:
            self.assertEqual(set(archive.namelist()), {
                "cult-like-launch/LICENSE",
                "cult-like-launch/THIRD_PARTY_NOTICES.md",
                "cult-like-launch/SKILL.md",
                "cult-like-launch/agents/openai.yaml",
                "cult-like-launch/references/business-discovery.md",
                "cult-like-launch/references/playbook-output.md",
                "cult-like-launch/references/framework.md",
                "cult-like-launch/references/original-post.txt",
                "cult-like-launch/references/images/figure-1.png",
                "cult-like-launch/references/images/figure-2.png",
            })
            for name, content in self.files.items():
                self.assertEqual(archive.read("cult-like-launch/" + name), content)
