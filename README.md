...
git clone https://github.com/xiaofei-du/cult-like-launch.git \
  "${CODEX_HOME:-$HOME/.codex}/skills/cult-like-launch"
```
...
```text
Use $cult-like-launch to create a Launch Playbook
...
contains only the installable `cult-like-launch/` directory with its
